...
ActiveRecord::Schema[7.0].define(version: 2022_12_31_124155) do
  ...
  create_table "games", force: :cascade do |t|
    ...
    t.integer "player1_moves", default: [], array: true
    t.integer "player2_moves", default: [], array: true
  end
  ...
  create_table "winning_numbers", force: :cascade do |t|
